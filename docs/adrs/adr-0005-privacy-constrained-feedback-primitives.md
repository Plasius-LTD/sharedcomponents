...
- Feedback opening cannot be correlated through the package's general
  ...
  opener. Unrelated footer links and menus retain their analytics behavior. A
  host that adds surrounding telemetry is responsible for preserving the same
  no-content, no-identifier boundary.
